...
| `GET`    | `/customers/{id}` | Einen einzelnen Kunden abrufen | –                                                                                                                                                                                                                                        |
| `POST`   | `/customers`      | Einen neuen Kunden erstellen   | –                                                                                                                                                                                                                                        |
| `PUT`    | `/customers/{id}` | Einen Kunden ändern            | –                                                                                                                                                                                                                                        |
...
| `GET`    | `/orders/{id}`    | Eine einzelne Order abrufen    | –                                                                                                                                                                                                                                        |
